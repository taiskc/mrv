  ...
  <div>
    <b-card>
        <div class="d-flex flex-row justify-content-around">
            <div class="clickable" :class="{'active': tabSelected == 'Invited'}" @click="setActive('Invited')">Invited</div>
            <div class="clickable" :class="{'active': tabSelected == 'Accepted'}" @click="setActive('Accepted')">Accepted</div>
        </div>
    </b-card>
    <div v-if ="tabSelected == 'Invited'">
        <b-card v-for="newLead in newLeads" v-bind:key="newLead.id"><new-lead-card :lead="newLead"/></b-card>
    </div>
    <div v-else>
        <b-card v-for="approvedLead in approvedLeads" v-bind:key="approvedLead.id"><new-lead-card :lead="approvedLead"/></b-card>
    </div>
  </div>
</template>
